...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body{margin:0;font-family:'Roboto',sans-serif;color:var(--text);line-height:1.6;display:flex;flex-direction:column;min-height:100vh}

    /* ===== HERO ===== */
    .hero{
      background:url('Imagens/Incendio20.jpg') center/cover no-repeat;
      color:#fff;height:35vh;text-align:center;display:flex;flex-direction:column;justify-content:center;position:relative
    }
    ...
    /* CTA relatar incêndio */
    .cta-report{max-width:1100px;margin:1.5rem auto 0;padding:0 1rem;position:relative;z-index:3}
    .cta-report .cta-card{
      display:grid;grid-template-columns:1fr auto;align-items:center;gap:1rem;background:#fff;border:1px solid #ffd8b5;border-radius:18px;
      padding:1.2rem 1.4rem;box-shadow:0 10px 30px rgba(0,0,0,.08);
    ...
    .cta-report .cta-btn{
      display:inline-flex;align-items:center;gap:.55rem;background:#ff9800;color:#fff;text-decoration:none;font-weight:800;
      padding:.8rem 1.15rem;border-radius:999px;border:1px solid #ef6c00;box-shadow:0 2px 10px rgba(239,108,0,.25);transition:filter .15s,transform .05s
    }
    .cta-report .cta-btn:hover{filter:brightness(.97)}
    .cta-report .cta-btn:active{transform:translateY(1px)}
    @media (max-width:700px){
      .cta-report .cta-card{grid-template-columns:1fr}
    ...
    .mini-cta{
      display:inline-flex;align-items:center;gap:.35rem;margin-top:.45rem;padding:.38rem .65rem;
      background:#e8f5e9;border:1px solid #cfe7d0;border-radius:9px;color:#2e7d32;font-weight:700;text-decoration:none;font-size:.92rem;transition:filter .15s,transform .05s
    }
    ...
    /* responsivo de cartões, programa, etc */
...
<body>
  ...
  <header>
    ...
    <nav aria-label="Principal">
      ...
      <div data-auth-container style="display: contents;">
        ...
        <a href="login.html" class="login-btn" data-i18n="nav.login" data-auth-link>Login / Registar</a>
      </div>
  ...
  <!-- SCRIM + MENU MOBILE (igual em todas as páginas) -->
  ...
  <section class="howto" aria-labelledby="howto-title">
    ...
    <div class="how-grid">
      ...
      <div class="how-card">
        ...
        <p data-i18n="how.step2.d">Ajuda a manter os dados da tua aldeia atualizados. Sinaliza também problemas que encontres no terreno.</p>
        <a class="mini-cta" href="aldeias.html#fichas" data-i18n="how.step2.cta">Adiciona informação/comentário</a>
      </div>
      <div class="how-card">
